...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    try {
        ...
        // Clean title
        const cleanTitle = data.title.replace(/\s*[-|]?\s*(?:Anime\s*Kompi|Mizunime)/gi, '').trim();

        return {
            title: `${cleanTitle} - Nonton Anime Sub Indo`,
            description: `Nonton ${cleanTitle} subtitle Indonesia terbaru dengan kualitas HD. Streaming dan download anime sub Indo gratis di Mizunime.`,
            keywords: [
                cleanTitle,
                `nonton ${cleanTitle}`,
                `${cleanTitle} sub indo`,
            ...
            openGraph: {
                title: `${cleanTitle} - Mizunime`,
                description: `Nonton ${cleanTitle} subtitle Indonesia terbaru dengan kualitas HD.`,
                type: 'video.episode',
            },
            twitter: {
            ...
            <div className="container mx-auto px-4 py-6">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="text-sm text-gray-400 mb-4 flex gap-2">
                        ...
                        <span>/</span>
                        <span className="text-white truncate">{cleanTitle}</span>
                    </div>
